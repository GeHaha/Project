...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.time_comboBox.setItemText(0, _translate("Form", "6小时"))
        self.time_comboBox.setItemText(1, _translate("Form", "1天"))
        self.time_comboBox.setItemText(2, _translate("Form", "3天"))
        self.time_comboBox.setItemText(3, _translate("Form", "7天"))
        self.time_comboBox.setItemText(4, _translate("Form", "15天"))
        self.time_comboBox.setItemText(5, _translate("Form", "1月"))
        self.time_comboBox.setItemText(6, _translate("Form", "3月"))
        self.time_comboBox.setItemText(7, _translate("Form", "6月"))
        self.time_comboBox.setItemText(8, _translate("Form", "1年"))
