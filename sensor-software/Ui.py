...
# Form implementation generated from reading ui file '光照度温度及湿度传感器工具软件-3.35(增加一个Open).ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Show_label.setGeometry(QtCore.QRect(100, 20, 271, 51))
        ...
        self.windSpeed_lineEdit = QtWidgets.QLineEdit(self.Watch_groupBox)
        self.windSpeed_lineEdit.setGeometry(QtCore.QRect(80, 150, 101, 31))
        self.windSpeed_lineEdit.setObjectName("Airspped_lineEdit")
        ...
        self.windSpeed_label.setObjectName("Airspeed_label")
