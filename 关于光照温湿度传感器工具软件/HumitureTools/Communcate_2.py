...
class RS485(minimalmodbus.Instrument):
    ...
    def slaveCommunicate(self):
        ...
        request = self.slaveEmbedPayload.request_data  
    ...
    def slaveEmbedPayload(self):
        ...
        functioncode = 0x03
        #要发送到从服务器的字节字符串
        payloaddata = b'abc\x00\x00\x00\x04'
        request_data = minimalmodbus._embedPayload(slaveaddress,mode,functioncode,payloaddata)        
        return request_data
   ...
   # 检验CRC   
    def CalcuCrc(self):       
        ...
        input = self.slaveCommunicate.raw_data
